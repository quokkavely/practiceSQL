...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO Users (username,email,password) VALUES ('jerry', 'jerry@naver.com', 'jellyJOA');";
  ...
  */
  public static final String PART2_10 = "INSERT INTO Posts (title, content, user_id) VALUES ('lucky','럭키비키야',1);";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-11. 어느 board에도 속하지 않는 post의 모든 데이터를 찾기위한 SQL을 작성해주세요.")
  */
  public static final String PART2_11 = "SELECT * FROM Posts p WHERE board_id IS NULL; ";
  ...
  */
  public static final String PART2_13 = "SELECT b.name FROM Boards b JOIN Posts p ON p.board_id = b.board_id WHERE p.user_id=1;";
  ...
  */
  public static final String PART2_15 = "SELECT Count(comment_id)as CommentCount FROM Comments c JOIN Users u " +
  ...
  */
  public static final String PART2_16 = "SELECT u.username, COUNT(c.content) FROM Users u LEFT JOIN Comments c ON c.user_id = u.user_id  GROUP BY u.username;";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-17. 각 board의 name과 해당 board에 속한 post의 개수 (컬럼명: PostCount)를 출력하기 위한 SQL을 작성해주세요.
  */
  public static final String PART2_17 = "SELECT b.name, Count(p.board_id) as PostCount FROM Boards b LEFT JOIN Posts p ON p.board_id = b.board_id GROUP BY b.name;";
  ...
  */
  public static final String PART2_18 = "SELECT b.name, AVG(LENGTH(p.content)) as AvgLength FROM Boards b  " +
          "LEFT JOIN Posts p ON p.board_id = b.board_id GROUP BY  b.name;";
  ...
  */
  public static final String PART2_20 = "SELECT t.name, Count(p.post_id)as PostCount FROM Tags t LEFT JOIN Post_Tags pt ON pt.tag_id = t.tag_id  " +
